...
class RealescraperSpiderMiddleware:
...
class RealescraperDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def __init__(self, settings):
        # Since the website forbade scraping, fake user agents were used to prevent banning.
